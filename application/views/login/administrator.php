...
<head>
    ...
    <title>Washoes - Admin Login</title>
...
<body>
    <div class="jumbotron">
        ...
        <img class="userlogin" src="<?php echo base_url('assets/image/user.png'); ?>" alt="admin">
		<form action="<?php echo base_url('alogin'); ?>" method="post">
